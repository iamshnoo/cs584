...
if __name__ == "__main__":
    ...
    for clf in classifiers:
        ...
        # print accuracy
        print(
            f"{clf.model_name} accuracy: {clf.score(X, train_dataset.y)}"
        )
        # print f1 score
        print(
            f"{clf.model_name} f1 score: {clf.f1_score(X, train_dataset.y)}"
        )
        ...
        # print recall score
        print(
            f"{clf.model_name} recall score: {clf.recall_score(X, train_dataset.y)}"
        )
        print("-" * 80)
